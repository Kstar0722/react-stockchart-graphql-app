...
var OHLCTooltip = function (_Component) {
	...
	_createClass(OHLCTooltip, [{
		...
		value: function renderSVG(moreProps) {
			...
			var displayValues = this.props.displayValues;
			...
			var _displayValues = displayValues(this.props, moreProps),
			    displayDate = _displayValues.displayDate,
			    open = _displayValues.open,
			    high = _displayValues.high,
			    low = _displayValues.low,
			    close = _displayValues.close,
			    volume = _displayValues.volume;
...
OHLCTooltip.propTypes = {
	...
	displayValues: _propTypes2.default.func,
...
function displayValues(props, moreProps) {
	...
	return {
		displayDate: displayDate, open: open, high: high, low: low, close: close, volume: volume
	};
}
